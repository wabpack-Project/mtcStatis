 ...
 */
 ...
 $.validator.addMethod("patientAgreeAttachment",function(value,element){
	var attachmentNum = $(".aci-patientInfo #uploadlist-1").children(".attachmentmeta").length;
	if(attachmentNum==0){
		return false;
	}
	return true;
...
/*  */
 $.validator.addMethod("consdoctor",function(value,element){
   
	
	 if ($('#doctorList > li').length == 0)
     {
         return false;
     }
	 return true;
 ...
 $.validator.addMethod("idCard",function(value,element){
	 ...
	 //if(value !=''&&value.search( /^([1-9][\d]{5}([1][9]\d{2}|[2][0][1][0-3]|[2][0][0][0-9])(([0][2](([0][1-9])|([1-2][0-9])))|((([0][4,6,9])|([1][1]))(([0][1-9])|([1-2][0-9])|([3][0])))|(([0][1,3,5,7,8]|([1][0])|([1][2]))(([0][1-9])|([1-2][0-9])|([3][0-1]))))[0-9]{3}[\dxX])$/) == -1) {
	 if(value !=''&&value.search(/^[1-9]\d{7}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}$|^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}([0-9]|X)$/) == -1) {
 ...
 $.validator.addMethod("phone",function(value,element){
	  ...
	  if(value !=''&&value.search(/^1[3-9]\d{9}$/) == -1) {
 ...
 $.validator.addMethod("tel",function(value,element){
	  ...
	  if(value !=''&&value.search(/^0\d{2,3}-\d{7,8}(-\d{1,6})?$/) == -1) {
...
;
 ...
 //验证空格和特殊字符
$.validator.addMethod("schar",function(value,element){
